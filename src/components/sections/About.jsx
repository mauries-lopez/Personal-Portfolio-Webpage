...
export const About = ( {setNavTitle, animateAboutBGClass, setAnimateAboutBGClass, setNavTitleColor, setNavBarColor, setNavMainMenuBtnColor, setNavSocialColor} ) => {
    ...
    return (
        <section id="about" ref={ref} className="relative h-full w-full top-0 flex flex-col justify-center items-center bg-black/95 overflow-hidden" >
            ...
            <div style={{ position: "absolute", bottom: 0, left: 0, right: 0, height: "50%", background: "linear-gradient(to top, rgba(0,0,0,1), transparent)", pointerEvents: "none"}}/>
            </div>
            ...
            <div id="arrowDownDiv" className="absolute bottom-4 left-1/2 transform -translate-x-1/2 z-20 h-[10%] w-[10%] flex justify-center items-center">
                <Link to="experience" spy={true} smooth={true} offset={-64} duration={500}>
                    <div className="-lg flex size-12 animate-bounce items-center justify-center rounded-full bg-black p-2 ring-1 ring-gray-900/100 dark:bg-white/30 dark:ring-white/100 cursor-pointer">
