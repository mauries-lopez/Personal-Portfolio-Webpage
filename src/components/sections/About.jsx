...
export const About = ({
  ...
  const [introductionDivName, setIntroductionDivName] =
    useState('+ Introduction')
  const [introductionDivBtnDisplay, setIntroductionDivBtnDisplay] =
    useState('block')
  const [introductionDisplay, setIntroductionDisplay] = useState('hidden')

  const [researchInterestDivName, setResearchInterestDivName] = useState(
    '+ Research Interest'
  )
  const [researchInterestDivBtnDisplay, setResearchInterestDivBtnDisplay] =
    useState('block')
  const [researchInterestDisplay, setResearchInterestDisplay] =
    useState('hidden')
  ...
  return (
    ...
    >
      <div
        className='fixed inset-0 bg-cover bg-fixed bg-center blur-[3px] z-0 scale-[1.1] bg '
      >
        <div
          style={{
            position: 'absolute',
      ...
      <div
        id='arrowDownDiv'
        className='absolute bottom-0 left-1/2 transform -translate-x-1/2 z-20 h-[10%] w-[10%] flex justify-center items-center animate-pulse'
      >
        <Link
          to='experience'
          spy
